...
O objetivo dessa aplicação é: Utilizando a API do GitHub, desenvolver uma busca de usuários, mostrando suas devidas informações de perfil e os seus repositorios, filtrados por número de estrelas e ordem alfabética.
...
```bash
# Baixe o repositório.
$ git clone https://github.com/kelvinteixeira/Github-Search.git
